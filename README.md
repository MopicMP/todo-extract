...
[![PyPI version](https://badge.fury.io/py/todo-extract.svg)](https://pypi.org/project/todo-extract/)
...
# Basic usage
result = extract("your input here")
print(result)
```
...
result = extract("Hello World")

# Example 2: Batch processing
from todo_extract import batch
